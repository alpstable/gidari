...
# sudo docker exec --privileged docker-mongo1-1 /scripts/rs-init.sh
docker-compose -f "third_party/docker/storage.docker-compose.yaml" exec mongo1 /scripts/rs-init.sh
