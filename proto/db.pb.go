...
type IteratorResult struct {
	...
	// Endpoint is the HTTP Url endpoint that was used to get the data for the IteratorResult.
...
func (x *IteratorResult) GetEndpoint() string {
	if x != nil {
		return x.Endpoint
	}
	return ""
...
var file_db_proto_rawDesc = []byte{
	...
	0x0c, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x40, 0x0a,
	...
	0x09, 0x52, 0x08, 0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x64,
